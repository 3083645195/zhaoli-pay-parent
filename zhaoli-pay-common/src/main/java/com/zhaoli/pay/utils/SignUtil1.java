...
public class SignUtil1 {
    ...
    private static Logger logger = LoggerFactory.getLogger(SignUtil1.class);

    /**
     * 加密密钥
     */
    private final static String APP_KEY = "zhaoli";
     ...
     * @return
     */
    public static boolean verifyJson(String sign, String timestamp, String json) {
        String mysign = DigestUtils.md5Hex(getContentBytes(json + "," + timestamp + APP_KEY, INPUT_CHARSET));
    ...
    /**
     * 加密
     * 将给的 json 数据进行加密 在其中加上时间戳 其中指定了加密密钥和字符的编码集
     *
     * @param json
     * @return
     */
    public static Map<String, String> signJson(String json) {
...
//        result.put("appKey", "123");
        result.put("orderName", "zhaoli");
        String json = result.toJSONString();
        System.out.println(json);
        Map<String, String> stringStringMap = SignUtil1.signJson(json);
